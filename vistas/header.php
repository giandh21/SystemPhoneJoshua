    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./escritorio.php" class="logo">
          ...
          <span class="logo-mini"><img src="../public/img/logo.png" class="img-thumbnail" alt=""></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Gestor de Almacén</b></span>
        </a>
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['ventas']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lVentas"><a href="venta.php"><i class="fa fa-circle-o"></i> Salidas</a></li>
                <li id="lClientes"><a href="cliente.php"><i class="fa fa-circle-o"></i> Sucursal</a></li>
              </ul>
            </li>';
            }
            ?>
