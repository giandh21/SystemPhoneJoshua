            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <h1 class="box-title"><strong>Panel de Permisos</strong>  <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
